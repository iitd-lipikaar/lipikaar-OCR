...
class BaseSystem(pl.LightningModule, ABC):
    ...
    def _eval_step(self, batch, count_var, validation: bool) -> Optional[STEP_OUTPUT]:
        images, labels = batch
        ...
        def copy_image(source_folder, destination_folder, filename):
            ...
            destination_path = f"{destination_folder}/{filename}.jpg"
    ...
    def test_step(self, batch, batch_idx, count_var) -> Optional[STEP_OUTPUT]:
        return self._eval_step(batch, count_var, False)
