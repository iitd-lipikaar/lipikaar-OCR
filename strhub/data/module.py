...
class SceneTextDataModule(pl.LightningDataModule):
    ...
    TEST_MAVI = ('test/lmdb1', 'test/lmdb2', 'test/lmdb3', 'test/lmdb4')
    TEST_KANNADA = ('kannada_tesseract',)
    TEST_TAMIL = ('tamil_iiith',)
    #TEST_ASSAMESE = ('assamese_arpan','assamese_iiith')
    TEST_ASSAMESE = ('assamese_iiith',)
